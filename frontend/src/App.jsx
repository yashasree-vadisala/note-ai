...
function buildPptx(slides, allCustomElements = {}, resolve, reject) {
  try {
...
async function generatePdfBlob(summary, source, allCustomElements = {}, slides = []) {
  if (!window.jspdf) {
...
async function generatePptxBlob(slides, allCustomElements = {}) {
  if (!window.PptxGenJS) {
    await new Promise((resolve, reject) => {
      const script = document.createElement("script");
...
function buildPdf(summary, source, allCustomElements, slides, resolve, reject) {
  try {
...
// ── Helper: draw a filled + stroked polygon in jsPDF ──────────────────────────
function drawPolygonPdf(doc, pts, accentRgb) {
...
// ─── HOME VIEW ─────────────────────────────────────────────────────────────────
function HomeView({ session, onResult, language, setLanguage }) {
...
// ─── RESULTS VIEW ───────────────────────────────────────────────────────────────
function ResultsView({ summary, source, onBack, onQuiz, onScenario, onChat, onPptReady, language })  {
...
// ─── PPT MODAL ─────────────────────────────────────────────────────────────────
function PptModal({ summary, onClose, onReady, language = "en" }) {
...
function ResizableSlidePreview({ slide, index, total, layout, onLayoutChange, customElements, renderCustomElement, slideTheme, slideThemes }) {
...
function InsertModal({ onClose, onInsert, type }) {
